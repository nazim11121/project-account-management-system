...
class SalaryController extends Controller
{
    ...
    {
        $salary = Profit::where('expense_head', 1)->where('type', 'dr')->orderBy('voucher_no','ASC')->get();
    ...
    {
        $salary = Profit::findOrFail($id);
        $salary->delete();
        
        $bankCashUpdate = BankCash::find($salary->source);           
        $bankCashUpdate->current_balance=$bankCashUpdate->current_balance+$salary->total;
        $bankCashUpdate->save();
