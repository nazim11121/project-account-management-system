...
<h4 class="fw-bold py-3 mb-4">
  <span class="text-muted fw-light">Account / Bank-Cash Account/</span> Create
</h4>
...
<div class="row">
  <div class="col-md-12">
    <div class="card mb-4">
      ...
      <hr class="my-0">
      <div class="card-body">
        <form id="formAccountSettings" method="POST" action="{{ route('account-bank-cash-store') }}" enctype="multipart/form-data">
        	@csrf
          <div class="row">
            ...
            <div class="mb-3 col-md-6">
              ...
              <input type="number" class="form-control" id="current_balance" name="current_balance" value="0" />
            </div>
            <div class="mb-3 col-md-6">
