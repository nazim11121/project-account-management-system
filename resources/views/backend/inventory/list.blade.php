...
<div class="col-md-12">
  <h4 class="fw-bold py-3 mb-4">
    ...
    <a href="{{ route('project-create') }}" class="btn btn-primary text-white float-right">Create</a>
  </h4>
</div>
        ...
        <?php foreach ($inventory as $key => $value): ?>
          <tr>
            ...
            @if($value->client_name=='')
              <td></td>
            @else
              <td><i class="fab fa-angular fa-lg text-danger me-1"></i> <strong>{{ $value->clients->name }}</strong></td>
            @endif
        		<td><i class="fab fa-angular fa-lg text-danger me-1"></i> <strong>{{ $value->assign_date }}</strong></td>
        		<td><i class="fab fa-angular fa-lg text-danger me-1"></i> <strong>{{ $value->submission_date }}</strong></td>
            <td><i class="fab fa-angular fa-lg text-danger me-1"></i> <strong>{{ $value->total_price }}</strong></td>
        		<td>
        		  <div class="dropdown">
        		    <button type="button" class="btn p-0 dropdown-toggle hide-arrow" data-bs-toggle="dropdown"><i class="bx bx-dots-vertical-rounded"></i></button>
        		    <div class="dropdown-menu">
        		      <a class="dropdown-item" href="{{ route('project-edit',$value->id) }}"><i class="bx bx-edit-alt me-1"></i> Edit</a>
