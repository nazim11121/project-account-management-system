        ...
        <form name="add_name" id="add_service" method="POST" action="{{ route('account-salary-store') }}" enctype="multipart/form-data">
          ...
          <div class="row">
            ...
            <div class="container mt-4">
                    ...
                    <tbody id="dataTable" class="form">
                      <tr>
                        ...
                        <td style="width: 200px">
                          <input type="text" class="subtotal form-control" id="subtotal_1" name="amount[]" required="">
                        </td>
                ...
                <div class="row float-end" style="margin-right: 100px; margin-top: 5px">
                  <label class="col-sm-3 col-form-label">Total : <span class="requiredStar" style="color: red"> * </span></label>
                  <div class="col-sm-7">
                    <input type="text" class="form-control" name="total" id="total" style="cursor: not-allowed;pointer-events:none;" required="">
                  </div>  
                </div><br>
