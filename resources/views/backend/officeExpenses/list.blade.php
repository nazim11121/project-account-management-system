...
<div class="col-md-12">
  <h4 class="fw-bold py-3 mb-4">
    <span class="text-muted fw-light">Account / </span> Office Expenses / List
    <a href="{{ route('account-office_expenses-create') }}" class="btn btn-primary text-white float-right" style="margin-top: 5px">Create</a>
  </h4>
</div>&nbsp;
        		...
        		<td>
        		  <div class="dropdown">
        		    ...
        		    <div class="dropdown-menu">
        		      <form action="{{ route('account-office_expenses-destroy', $value->id)}}" method="post">
        		        @csrf
        		        @method('DELETE')
