...
<div class="col-md-12">
  <h4 class="fw-bold py-3 mb-4">
    <span class="text-muted fw-light">Product Inventory / </span> List
      ...
      <tbody class="table-border-bottom-0">
        ...
        <?php foreach ($product as $key => $value): ?>
          <tr>
        		...
        		<td><i class="fab fa-angular fa-lg text-danger me-1"></i> <strong>{{ $value->unit }}</strong></td>
            <td><i class="fab fa-angular fa-lg text-danger me-1"></i> <strong>{{ $value->unit_price }}</strong></td>
        		<td><i class="fab fa-angular fa-lg text-danger me-1"></i> <strong>{{ $value->stock }}</strong></td>
        		<td><i class="fab fa-angular fa-lg text-danger me-1"></i> <strong>{{ $value->file }}</strong></td>
        		<td>
        		  <div class="dropdown">
        		    <button type="button" class="btn p-0 dropdown-toggle hide-arrow" data-bs-toggle="dropdown"><i class="bx bx-dots-vertical-rounded"></i></button>
        		    <div class="dropdown-menu">
        		      <a class="dropdown-item" href="{{ route('product-edit',$value->id) }}"><i class="bx bx-edit-alt me-1"></i> Edit</a>
