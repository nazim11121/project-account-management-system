...
<h4 class="fw-bold py-3 mb-4">
  <span class="text-muted fw-light">Account / Stationary / </span>Create  
</h4>

<div class="row">
  <div class="col-md-12">
    <div class="card mb-4">
      <h5 class="card-header">Stationary Details</h5>
      <hr class="my-0">
      <div class="card-body" id="card-body">
        <form name="add_name" id="add_service" method="POST" action="{{ route('account-stationary-store') }}" enctype="multipart/form-data">
        	@csrf
          <div class="row">
...
<script type="text/javascript">
  ...
  $(document).ready(function () {
    ...
    $.ajax({
      ...
      url:"{{ route('account-stationary-create-pjname') }}",
