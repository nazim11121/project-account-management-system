...
<div class="col-md-12">
  <h4 class="fw-bold py-3 mb-4">
    ...
    <a href="{{ route('vendor-create') }}" class="btn btn-primary text-white float-right">Create</a>
  </h4>
</div>
        		...
        		<td>
        		  <div class="dropdown">
        		    ...
        		    <div class="dropdown-menu">
        		      <a class="dropdown-item" href="{{ route('vendor-edit',$value->id) }}"><i class="bx bx-edit-alt me-1"></i> Edit</a>
        		      <form action="{{ route('vendor-destroy', $value->id)}}" method="post">
        		        @csrf
        		        @method('DELETE')
